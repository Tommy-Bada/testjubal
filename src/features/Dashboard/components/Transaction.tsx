...
export default function Transaction({
  ...
  return (
    <div className="bg-white p-[2rem] justify-between flex rounded-[1rem]">
      <div className="flex">
        <Image src={profileImage} alt="" width="36" height="36" />
        <div className="ml-[1rem]">
          <p className="text-[1.8rem] font-[700] text-jubalNav">{title}</p>
          <p className="text-[1.4rem] text-jubalFormText my-[1rem]">{type}</p>
          <p className="text-[1.4rem] text-jubalViolet">See Details</p>
        </div>
      </div>
      <div>
