  ...
  return (
    <div className="p-[2rem]">
      <div className="flex justify-between p-[1rem]">
        <p className="text-[1.8rem] text-jubalFormText">Financial Statistics</p>
        <div className="flex items-center">
          <p className="text-[1.4rem] mr-[1rem] text-jubalFormText">Deposit</p>
          <div className="bg-[#0F973D] w-[2.5rem] h-[4px]"></div>
        </div>
        <div className="flex items-center">
          <p className="text-[1.4rem] mr-[1rem] text-jubalFormText">Transfer</p>
